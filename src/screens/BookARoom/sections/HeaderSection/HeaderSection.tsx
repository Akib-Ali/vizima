...
const trustBoosters = [
  {
    icon: "https://c.animaapp.com/mbdx675eoAM9mA/img/eva-award-fill.svg",
    alt: "Eva award fill",
    text: "100% Verified Properties",
    width: "246px",
  },
  {
    icon: "https://c.animaapp.com/mbdx675eoAM9mA/img/material-symbols-bed.svg",
  ...
  {
    specialIcon: true,
    iconSrc: "https://c.animaapp.com/mbdx675eoAM9mA/img/group-1.png",
    alt: "Group",
...
export const HeaderSection = (): JSX.Element => {
  return (
    <section className="flex flex-col w-full items-center gap-[30px] pt-2.5 pb-8 px-0 relative [background:linear-gradient(180deg,rgba(0,0,0,0)_0%,rgba(0,0,0,0.2)_100%),url(https://c.animaapp.com/mbdx675eoAM9mA/img/adkoghe.png)_50%_50%_/_cover]">
